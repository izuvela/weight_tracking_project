...
import { updateUser } from "../api/users"; // Make sure to define this function in your api
...
const UpdateUserScreen = ({ user, closeModal, setUser }) => {
  return (
    <ScrollView>
      <View style={styles.container}>
        <Formik
          initialValues={{
            ...
            physical_activity_level: user.physical_activity_level.toString(),
          ...
          onSubmit={(values) => {
            const storeData = async (value) => {
              try {
                console.log(value);
                const userData = await updateUser(user.id, value);
                setUser(userData);
